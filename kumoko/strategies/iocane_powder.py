...
# Name: IO2_fightinguuu
# Author: sdfsdf
# Date: 2013-04-16
# Source: http://www.rpscontest.com/entry/885001

#Iocaine powder based AI
import random


class IocanePowderStrategy(BaseAtomicStrategy):
  def __init__(self):
    super().__init__()
  ...
  def __call__(self, history):
    ...
    input = history.his_moves[-1]
    self.output = history.our_moves[-1]
