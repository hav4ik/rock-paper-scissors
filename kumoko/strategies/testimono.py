# Name: testinonmo
# Url: http://www.rpscontest.com/entry/5704460596674560
# Author	ido
# Submission date	2019-12-21 17:51:36.367585
# Rating	7950
# Matches played	212
# Win rate	81.13
...
class TestimonoStrategy(BaseAtomicStrategy):
  def __init__(self):
    self.code = compile("""
...
prev = output""", '<string>', 'exec')
  ...
  def __call__(self, history):
      ...
      self.gg['input'] = his_last_move
      self.gg['output'] = our_last_move
      self.gg['prev'] = our_last_move
